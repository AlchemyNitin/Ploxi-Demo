...
const handleSubmit = async () => {
  ...
  try {
    // Prepare full investor profile payload
    ...
    // Backend API ready for future implementation
    console.log('API Ready - POST /api/climate-finance/investor/register', investorProfile);

  
    router.push('/climate-finance/dashboard');
