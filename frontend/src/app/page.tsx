...
export default function HomePage() {
  ...
  <section className="relative overflow-hidden bg-gradient-to-r from-primary-600 via-emerald-600 to-teal-600 py-16 sm:py-20">
    ...
    <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
      ...
      {/* Badge */}
      <div className="inline-flex items-center gap-2 rounded-full border border-[#8ae2b4] bg-[#6fb691] backdrop-blur-md px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-[#253e31] sm:text-sm shadow-sm">
